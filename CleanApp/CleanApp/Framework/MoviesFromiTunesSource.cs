...
using CleanApp.Framework.Model;
using Newtonsoft.Json;

namespace CleanApp.Framework
{
    /// <summary>
    ...
    /// </summary>
    public class MoviesFromiTunesSource : IMoviesSource
    {
        ...
        public async Task<IReadOnlyList<Movie>> GetMoviesFromSourceAsync(string search, int pageNo = 1)
        {
